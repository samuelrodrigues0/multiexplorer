...
class NSGA2Utils(object):
    ...
    def __init__(self, problem, num_of_individuals, projectFolder, prediction, mutation_rate= 0.9 ,mutation_strength=0.01, num_of_genes_to_mutate=2, num_of_tour_particips=2, inputName=None):
        ...
        inputNsga= InOut(projectFolder, inputName, prediction)
