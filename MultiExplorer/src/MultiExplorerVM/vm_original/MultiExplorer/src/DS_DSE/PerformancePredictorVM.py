...
class PerformancePredictor(object):
    ...
    def __init__(self, mips, coresvm, price, instructions, corescloudlet, heterogeneous):
        ...
        self.preditorTime = joblib.load("/multiexplorer/MultiExplorer/src/MultiExplorerVM/vm_original/MultiExplorer/src/DS_DSE/predictors/"+'timepredictor2022-2.pkl')#carregou o preditor
        self.scalatorTime = joblib.load("/multiexplorer/MultiExplorer/src/MultiExplorerVM/vm_original/MultiExplorer/src/DS_DSE/predictors/"+'scalertime2022.pkl')#carregou o escalador do conjunto de entrada

        self.preditorCost = joblib.load("/multiexplorer/MultiExplorer/src/MultiExplorerVM/vm_original/MultiExplorer/src/DS_DSE/predictors/"+'costpredictor2022.pkl')#carregou o preditor
        self.scalatorCost = joblib.load("/multiexplorer/MultiExplorer/src/MultiExplorerVM/vm_original/MultiExplorer/src/DS_DSE/predictors/"+'scalercost2022.pkl')#carregou o escalador do conjunto de entrada
